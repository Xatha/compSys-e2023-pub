...
int main(void) {
  ...
  assert(list_insert_first(l, &second) == 0);
  assert(list_insert_first(l, &first) == 0);
  assert(list_insert_last(l, &third) == 0);

  assert(list_remove_first(l, (void*)&result) == 0);
  assert(*result == first);
